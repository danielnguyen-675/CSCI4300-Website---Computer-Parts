...
<body>
    ...
    <aside id="leftSide">
        <div class="vertical-menu">
            ...
            <a href="./displayCategories.php?categoryName=GPU" class="active"><button type="button" class="sideMenuButton">Graphics Cards</button></a>
                    ...
                    <div class="column">
                        <form action="includes/addtocart.inc.php" method="post">
                            <a href="productView.php?productID=<?php echo $product['productID'] ?>">
                                <img src="<?php echo $product['productImage'] ?> " class="GPUImg" alt="Picture Unavailable" />
                            </a>
