...
$query = "SELECT * FROM products WHERE categoryName='Power Supply'";
...
<body>
    ...
    <aside id="leftSide">
        <div class="vertical-menu">
            ...
            <a href="./displayPowerSupplies.php" class="active"><button type="button" class="sideMenuButton">Power Supplies</button></a>
